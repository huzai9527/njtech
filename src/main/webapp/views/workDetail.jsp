...
<html>
	...
	<body>
		...
		<div class="nav_menu">
			...
			<a href="/views/index.html" class="nav_list fr"><img src="images/cs.png" /></a>
			...
			<div class="inside_con">
				...
				<div class="inside_box">
					...
					<div class="ic_wrap fr">
						<h3 class="n_title">${work.title}<span class="n_date">发布日期：${work.time}</span></h3>
						${work.content}
						<div class="n_link">
	                        <ul>
	                            <li>上一条<a href="/views/workDetail?id=${work1.id}">${work1.title}</a><span class="date">${work1.time}</span></li>
	                            <li>下一条<a href="/views/workDetail?id=${work2.id}">${work2.title}</a><span class="date">${work2.time}</span></li>
	                        </ul>
	                    </div>
					</div>
					<div class="clear"></div>
