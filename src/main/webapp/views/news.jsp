			...
			<div class="inside_con">
				...
				<div class="inside_box">
					...
					<div class="ic_wrap fr">
						<ul class="news_list">
							<c:forEach items="${schoolNews}" var="item">

								<li><a href="newsDetail?id=${item.getId()}">${item.getTitle()}</a><span class="date">[  <fmt:formatDate value="${item.getTime()}" pattern="yyyy/MM/dd  HH:mm:ss" />]</span></li>
							</c:forEach>
						</ul>
						<!--分页-->
						<div class="record">
	                        <span class="prev"><a href="/views/school?page=${page.prefPage}">上一页</a></span>
	                        <span class="word"><a href="/views/school?page=1">1</a></span>
	                        <span class="word"><a href="/views/school?page=2">2</a></span>
	                        <span class="word"><a href="/views/school?page=3">3</a></span>
	                        <span class="word"><a href="/views/school?page=4">4</a></span>
	                        <span class="word"><a href="/views/school?page=5">5</a></span>
	                        <span class="word"><a href="/views/school?page=6">6</a></span>
	                        <span class="next"><a href="/views/school?page=${page.nextPage}">下一页</a></span>
