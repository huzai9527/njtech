	...
	<body>
				...
				<ul id="nav" class="nav clearfix">
					...
					<li class="nLi">
						...
						<ul class="sub">
							...
							<li><a href="news.workdynamic?page=1">工作动态</a></li>
						</ul>
					</li>
					<li class="nLi">
		...
		<div class="inside_wrap">
			<div class="inside_con">
				<div class="adr">
					<a href="index.jsp">首页</a>&nbsp;>&nbsp;通知公告
				</div>
				<div class="inside_box">
					<div class="sidemenu fl">
						<div class="s_title">通知公告</div>
						<ul>
							<li class="on"><a href="notice.jsp">通知公告</a></li>
						</ul>
					</div>
					<div class="ic_wrap fr">
						<ul class="news_list">
							<c:forEach  items="${list}" var="item">
								<li><a href="noticeDetail?id=${item.id}">${item.title}</a><span class="date">[  <fmt:formatDate value="${item.time}" pattern="yyyy/MM/dd  HH:mm:ss" />]</span></li>
							</c:forEach>
						</ul>
						<!--分页-->
						<div class="record">
